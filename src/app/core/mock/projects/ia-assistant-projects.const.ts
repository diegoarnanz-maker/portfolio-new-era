...
export const IA_ASSISTANT_PROJECTS: Project[] = [
  {
    ...
    status: 'completed',
    longDescription: 'Asistente por voz para tareas del día a día con integración a APIs externas. Descubre las capacidades de procesamiento de voz y automatización inteligente.',
    images: [
